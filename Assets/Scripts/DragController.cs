...
public class DragController : MonoBehaviour
{
    ...
    void UpdateDragStatus(bool IsDragging)
    {
        ...
        // Activar o desactivar el collider
        if (_lastDragged.TryGetComponent<Collider2D>(out var col))
        {
            col.enabled = !IsDragging;              // Se desactiva cuando empieza el drag
            col.isTrigger = !IsDragging;            // Trigger = false durante el drag (opcional)
        }
    }
}